...
describe('ListComponent', () => {
  ...
  it('should enlist all the countries', () => {
    let fixture = TestBed.createComponent(ListComponent);
    let list = fixture.componentInstance;
    fixture.detectChanges();
    expect(list.searchCountriesList).toEqual(["Afghanistan", "Albania", "Algeria", "Andorra", "Angola", "Anguilla", "Antigua & Barbuda", "Argentina", "Armenia", "Aruba", "Australia", "Austria", "Azerbaijan", "Bahamas"
  ...
  it('should filter the countries', inject([DataService], (service: DataService) => {
    let fixture = TestBed.createComponent(ListComponent);
    let list = fixture.componentInstance;
    fixture.detectChanges();
    list.ngOnInit();
